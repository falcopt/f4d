#ifndef _F4D_INSTANCE_HPP_
#define _F4D_INSTANCE_HPP_
...
namespace cobra {
    ...
    public:
        ...
        Instance& operator=(Instance&& source) = default;
        ...
        /**
         * Returns the sum of the demands of all the customers.
         * @return demand sum
         */
        inline int get_demand_sum() const {
            return demand_sum;
        };
         ...
         */
        inline float get_x_coordinate(int i) const {
         ...
         */
        inline float get_y_coordinate(int i) const {
        ...
        inline int get_nth_neighbor_of(int i, int n) const {
