...
namespace cobra {
    ...
    protected:
        ...
        inline Cache12 prepare_cache12(const Solution &solution, int vertex) {
            ...
            c.seqrem1 = -solution.get_prev_cost(c.prev, c.prevprev) - solution.get_next_cost(c.v);
            c.seqrem2 = -solution.get_prev_cost(c.prevprev, c.prevprevprev) - solution.get_prev_cost(c.v);
        ...
        inline Cache12 prepare_cache12(const Solution &solution, int vertex, int backup) {
            ...
            c.seqrem1 = -solution.get_prev_cost(c.prev, c.prevprev) - solution.get_next_cost(c.v, c.next);
            c.seqrem2 = -solution.get_prev_cost(c.prevprev, c.prevprevprev) - solution.get_prev_cost(c.v, c.prev);
