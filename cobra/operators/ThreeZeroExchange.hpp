...
namespace cobra {
    ...
    public:
        ThreeZeroExchange(const cobra::Instance &instance, MoveGenerators &moves, float tolerance) : AbstractOperator(instance, moves, tolerance) { }
    ...
    protected:
        ...
        struct Cache2 : std::conditional<handle_infeasible_solutions, Cache12MaybeInfeasible, Cache12AlwaysFeasible>::type {
            int v, prev;
            float seqrem2;
        };
