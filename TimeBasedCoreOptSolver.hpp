...
public:
    ...
    cobra::Solution fastopt(const cobra::Solution& warm_start, int coreopt_iterations) {
        ...
        if (coreopt_iterations == 0) return warm_start;
...
cobra::Solution fastopt_ls(const cobra::Solution& warm_start, int coreopt_iterations) {
        ...
        auto rvnd0 = cobra::RandomizedVariableNeighborhoodDescent(
            ...
            {cobra::E11,   cobra::E10,  cobra::TAILS, cobra::SPLIT, cobra::RE22B, cobra::E22,  cobra::RE20,  cobra::RE21,  cobra::RE22S, cobra::E21, cobra::E20, cobra::TWOPT},
            rand_engine, tolerance);

        auto fast_local_search = cobra::VariableNeighborhoodDescentComposer(tolerance);
        fast_local_search.append(&rvnd0);
        ...
        for (auto iter = 0; iter < coreopt_iterations; iter++) {
            ...
            fast_local_search.sequential_apply(neighbor);
