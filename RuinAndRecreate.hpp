#ifndef _F4D_RUINANDRECREATE_HPP_
#define _F4D_RUINANDRECREATE_HPP_
...
public:
    ...
    int apply(cobra::Solution& solution, std::vector<int>& omega, std::vector<int>& removed) {
        ...
        for (auto customer : removed) {
            ...
            for (auto route = solution.get_first_route(); route != solution.get_end_route(); route = solution.get_next_route(route)) {
                ...
                const auto cost = -instance.get_cost(instance.get_depot(), solution.get_last_customer(route)) +
                                  instance.get_cost(solution.get_last_customer(route), customer) + instance.get_cost(customer, instance.get_depot());
            ...
            if (best_route == solution.get_end_route() || (2.0f * instance.get_cost(instance.get_depot(), customer) < best_cost)) {
