#ifndef _F4D_LRUCACHE_HPP_
#define _F4D_LRUCACHE_HPP_
...
namespace cobra {
    ...
    public:
        ...
        LRUCache(const LRUCache &other) : cache_size(other.cache_size), cache(other.cache), counter(other.counter), head(other.head), tail(other.tail) { }
